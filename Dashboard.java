...
public void VerifyMain() throws InterruptedException {
//webDriver.manage().window().maximize();
webDriver.get("http://localhost:4200/dashboard");
...
webDriver.findElement(By.xpath("/html/body/app-root/app-toy/main/main/div[2]/div[2]/div[3]/button")).click();
Thread.sleep(2000);
}
...
public void VerifyDessert() throws InterruptedException {
//webDriver.manage().window().maximize();
webDriver.get("http://localhost:4200/dashboard");
...
public void VerifyBeverages() throws InterruptedException {
//webDriver.manage().window().maximize();
webDriver.get("http://localhost:4200/dashboard");
